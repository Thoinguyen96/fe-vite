...
const BookModalCreate = (props) => {
    const { setIsModalUploadBook, isModalUploadBook, fetchPaginateBooks } = props;
    ...
    const onFinish = async (values) => {
        ...
        setIsSubmit(true);
        const res = await createBooks(thumbnail, slider, mainText, author, price, sold, quantity, category);
        if (res && res.data) {
            message.success("Create books success");
